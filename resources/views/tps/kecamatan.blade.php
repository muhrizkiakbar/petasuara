                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" hidden id="id" name="id" value="{{encrypt($kecamatan->id)}}">
                                        <input id="namakecamatan" name="namakecamatan"  class="form-control" value="{{$kecamatan->namakecamatan}}" type="text">
                                    </div>
                                    <div class="form-group">
                                        <label>Kabupaten/Kota</label>
                                        <select class="form-control select2" id="kabupaten_id" name="kabupaten_id" value="{{$kecamatan->kabupaten_id}}" style="width: 100%;">
