      ...
      <div class="content-wrapper">
          ...
          <section class="content">
                ...
                <div class="box box-default">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form action="/kabupaten/edit" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Kabupaten/Kota</label>
                                        <input type="text" hidden id="id" name="id" value="{{encrypt($kabupaten->id)}}" >
                                        <input id="namakabupaten" name="namakabupaten" type="text" class="form-control" value="{{$kabupaten->namakabupaten}}" placeholder="Nama Kabupaten">
                                    </div>
                                </div>
                            </div>
                            {{csrf_field()}}
