          ...
          <section class="content">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title">Edit TPS</h3>
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form action="/tps/edit" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>TPS</label>
                                        <input type="text" hidden id="id" name="id" value="{{encrypt($tp->id)}}" >
                                        <input id="namatps" name="namatps" value="{{$tp->namatps}}" class="form-control" type="text">
                                    </div>
                                    <div class="form-group">
                                        <label>Kecamatan</label>
                                        <select class="form-control select2" id="desa_id"  name="desa_id" value="{{$tp->desa_id}}" style="width: 100%;">
